...
eu_save_fortin_table_grouped_tex <- function(all_results,
                                             ...
                                             digits_ratio = 2,
                                             digits_rmse = 2,
                                             note = "Note: This table reports the RMSE of the AR,BIC model, and the ratio of the root mean squared predictive error (RMSE) relative to the benchmark AR,BIC model. A star (*) indicates significance at the 10\\% level in the Diebold--Mariano test. Green cells indicate the lowest RMSE ratio within each target-horizon column, including ties.",
